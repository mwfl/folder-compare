...
Visual Studio 2022 is supported through `vs2022-x64`. A standalone build fetches the pinned MWFL `v0.2.0` release; the VS 2026 preset uses a neighboring checkout for development.
